...
<div class="recipe-detail-container">
    ...
    <div class="recipe-header">
        <div class="recipe-image-container">
            @if($recipe->foto)
                <img src="{{ asset('storage/' . $recipe->foto) }}" alt="{{ $recipe->name }}" class="recipe-image">
            @else
            ...
            @else
                <form id="reviewForm" method="POST" action="{{ route('frontend.reviews.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="comment" id="comment" rows="4" required placeholder="Bagikan pengalaman Anda memasak resep ini..."></textarea>
                    </div>
