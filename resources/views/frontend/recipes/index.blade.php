        ...
        <div class="pagination-container">
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                    ...
                    @else
                        <li class="page-item"><a class="page-link" href="{{ $recipes->previousPageUrl() }}" rel="prev">&laquo;</a></li>
                    @endif
                    ...
                    @foreach ($recipes->getUrlRange(1, $recipes->lastPage()) as $page => $url)
                        ...
                        @elseif ($page == 1 || $page == $recipes->lastPage() || ($page >= $recipes->currentPage() - 2 && $page <= $recipes->currentPage() + 2))
                    ...
                    @if ($recipes->hasMorePages())
                        <li class="page-item"><a class="page-link" href="{{ $recipes->nextPageUrl() }}" rel="next">&raquo;</a></li>
                    @else
